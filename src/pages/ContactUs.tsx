    ...
    <div className="bg-stone-50 text-stone-800 font-sans antialiased">
      ...
      <main>
        <Helmet>
          ...
          <meta
            name="description"
            content="Have questions, feedback, or business inquiries? Contact IndSpice Organics through our form or reach us via email or phone. We'd love to hear from you!"
          />
          <meta property="og:title" content="Contact IndSpice Organics" />
          <meta
            property="og:description"
            content="Reach out to IndSpice Organics for questions, collaborations, or customer support. We're here to help!"
          />
          <meta
            property="og:image"
            content="https://indspiceorganics.com/assets/contact-image.png"
          />
          <meta
            property="og:url"
            content="https://indspiceorganics.com/contact"
          />
