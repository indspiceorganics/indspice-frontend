              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
                  ...
                  <div className="prose prose-stone max-w-none text-stone-700">
                    ...
                    <p>
                      IndSpice Organics was born from a deep reverence for
                      India's rich culinary heritage and the timeless wisdom of
                      organic farming. Inspired by the vibrant spice fields of
                      Rajasthan, our founders envisioned a way to bring the
                      purest, most aromatic spices directly from dedicated
                      farmers to kitchens worldwide.
                    </p>
                    <p>
                      We believe that the best flavors come from nature,
                      untouched and unadulterated. Our mission is simple: to
                      provide premium, certified organic spices that elevate
                      your cooking while supporting sustainable agriculture and
                      empowering local farming communities.
                    </p>
                    <p>
                      From meticulous sourcing to careful processing, we ensure
                      every pinch carries the authentic taste and natural
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
                  ...
                  <div className="flex flex-col items-center p-6">
                    ...
                    <p className="text-stone-600 text-sm leading-relaxed">
                      Certified organic spices, free from pesticides and
                      chemicals, ensuring natural taste and quality.
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col items-center p-6">
                    ...
                    <p className="text-stone-600 text-sm leading-relaxed">
                      Fair wages and direct relationships with farmers,
                  ...
                  <div className="flex flex-col items-center p-6">
                    ...
                    <p className="text-stone-600 text-sm leading-relaxed">
                      Rigorous testing and careful selection ensure superior
                      aroma, flavor, and potency in every batch.
                    </p>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
                  ...
                  <div className="prose prose-stone max-w-none text-stone-700">
                    ...
                    <p>
                      ...
                      organic farms primarily in the fertile lands of Rajasthan
                      and other spice-rich regions of India. This direct
                      connection allows us to guarantee the provenance and
                      quality of our spices.
                    </p>
                    <p>
                      Our partners practice traditional, sustainable farming
                      methods that respect the earth and yield spices bursting
                      with natural character. We visit the farms, understand the
                      process, and ensure every step aligns with our stringent
                      organic standards.
                    </p>
                  </div>
                </div>
